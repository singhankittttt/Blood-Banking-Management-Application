			...
			<div class="d-flex">
				...
				<div class="col-lg-7 contact-right-w3l">
					<h5 class="title-w3 text-center mb-5">Get In Touch</h5>
						...
						%>
						<div class="alert alert-success" id="success">Thanks for contacting us! We will get in touch with you.</div>
						<%
							}
						%>
					<form action="ContactHelp" method="post">
						<div class="d-flex space-d-flex">
							<div class="form-group grid-inputs">
								<input type="text" class="form-control" id="name"
									name="fullname" placeholder="Please enter your name." onkeypress="return lettersValidate(event)" required>
							</div>
							<div class="form-group grid-inputs">
								<input type="text" class="form-control" id="phone"
									name="contactno" placeholder="Please enter your mobile number." onkeypress="return numberValidate(event)" maxlength="10" required>
							</div>
						</div>
						<div class="form-group">
							<input type="email" class="form-control" id="email" name="email"
								required placeholder="Please enter your email address." required>
						</div>
						<div class="form-group">
							<textarea rows="10" cols="100" class="form-control" id="message"
								name="message" placeholder="Please enter your message"
