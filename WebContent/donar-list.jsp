...
<head>
<title>Blood Bank Management System | Blood Donar List</title>
<!-- Meta tag Keywords -->
			...
			<div class="d-flex">
				...
				<div class="row package-grids mt-5" style="padding-left: 50px;">
					...
					<div class="col-md-4 pricing">
						<div class="price-top">
							<img src="images/blood-donar.jpg" alt="Blood Donot"
								style="border: 1px #000 solid; width: 400px;" class="img-fluid" />
