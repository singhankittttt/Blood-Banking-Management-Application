...
<head>
<title>Blood Bank Management System !! Request Received</title>
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form"
					...
					<h5 class="title-w3 text-center mb-5">Below is the detail of
						Blood Requirer.</h5>
					<table border="1" class="table table-bordered">
						...
						<%
							int count = 0;
							ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("SELECT tblbloodrequirer.BloodDonarID,tblbloodrequirer.name,tblbloodrequirer.EmailId,tblbloodrequirer.ContactNumber,tblbloodrequirer.BloodRequirefor,tblbloodrequirer.Message,tblbloodrequirer.ApplyDate,tblblooddonars.id as donid from  tblbloodrequirer join tblblooddonars on tblblooddonars.id=tblbloodrequirer.BloodDonarID where tblbloodrequirer.BloodDonarID='"+ session.getAttribute("did") + "'");
